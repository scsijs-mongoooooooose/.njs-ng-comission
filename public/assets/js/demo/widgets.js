        ...
        function pchart(id){
            $(id).highcharts({
                ...
                chart: {
                    ...
                    events: {
                        load: function(){
                            ...
                            var d = parseInt( $(id).attr('data-value') );
                            this.series[0].setData([d, 100 - d]);
                ...
                tooltip: {
                    shared: true,
                    useHTML: true,
                    headerFormat: '<span>{point.y}%</span>',
                    pointFormat: '',
                    footerFormat: '',
                    valueDecimals: 2,
                    ...
                    $('#high-column').highcharts({
                        ...
                        tooltip: {
                            ...
                            positioner: function (boxWidth, boxHeight, point) {
                                var nX = ((column1.width() - 80) / 2) + ((point.plotX - ((column1.width() - 80) / 2)) / 2);
                                var nY = (column1.height() / 2) + ((point.plotY - (column1.height() / 2)) / 2) - 12;
                                column1.find(".high-tooltip").css("width", column1.width() - nX - 50);
                                return { x: nX, y: nY};
                            }
                        },
